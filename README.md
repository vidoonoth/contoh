...
6.Run `php artisan migrate --seed` to create the database manajemen-pelanggan and seed the roles and users manajemen-pelanggan
...
Besides the dashboard, the auth pages, the billing and manajemen-pelanggan pages, it has also an edit profile page. All the necessary files are installed out of the box and all the needed routes are added to `routes/web.php`. Keep in mind that all of the features can be viewed once you login using the credentials provided or by registering your own user.
