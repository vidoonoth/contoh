<nav class="navbar navbar-main navbar-expand-lg mx-5 px-0 shadow-none rounded" id="navbarBlur" navbar-scroll="true">
    <div class="container-fluid py-1 px-2">
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4 gap-3" id="navbar">
            ...
            <ul class="navbar-nav  justify-content-end">
                ...
                <li class="nav-item ps-2 d-flex align-items-center border-radius-xl">
                    <a href="javascript:;" class="nav-link text-body p-0">
                        <img src="../assets/img/team-2.jpg" class="avatar avatar-sm border-radius-xl" alt="avatar" />
                    </a>
                </li>
            </ul>
