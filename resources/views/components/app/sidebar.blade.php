<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 bg-slate-900 fixed-start " id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand d-flex align-items-center m-0"
            ...
            <span class="font-weight-bold text-lg">Apotek</span>
        </a>
    </div>
    ...
    <a class="nav-link collapsed"
       ...
       href="#laravelExamplesCollapse"  {{-- ID unik untuk target collapse --}}
       role="button"
       aria-expanded="false"          {{-- Default ke tertutup --}}
       aria-controls="laravelExamplesCollapse">
...
<div class="collapse {{ request()->routeIs(['users.profile', 'users-management']) ? 'show' : '' }}" id="laravelExamplesCollapse">
    ...
    <div class="mt-4 px-4 font-weight-bold breadcrumb-text text-white">        
